...
# Banana.dev OpenBuddy-Llama2-13B-v11.1-GPTQ starter template

This is a OpenBuddy-Llama2-13B-v11.1-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-openbuddy-llama2-13b-v11.1-gptq/fork) repository to your own Github account.
